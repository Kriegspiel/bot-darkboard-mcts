...
- `DARKBOARD_MCTS_SELECTION_RULE` (`value` default; `visits` remains available)
- `DARKBOARD_MCTS_SEED`
...
- `DARKBOARD_ENDGAME_MATERIAL_ADVANTAGE_START`
- `DARKBOARD_ENDGAME_MATERIAL_ADVANTAGE_FULL`
- `DARKBOARD_ENDGAME_LOW_OPPONENT_MATERIAL_START`
- `DARKBOARD_ENDGAME_LOW_OPPONENT_MATERIAL_FULL`
